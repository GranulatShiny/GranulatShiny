...
La PERMANOVA, ou Analyse de Variance Permutationnelle Multivariée, est une méthode statistique qui permet d'analyser les différences entre plusieurs groupes définis par des caractéristiques qualitatives, comme par exemple les différents traitements dans une étude expérimentale.
